...
pub unsafe fn create_texture_image(
    ...
    image_view::transition_image_layout(
        device,
        data,
        data.texture_image,
        data.mip_levels,
    ...
    image_view::copy_buffer_to_image(
        device,
        data,
        staging_buffer,
        data.texture_image,
...
pub unsafe fn create_texture_image_view(device: &Device, data: &mut AppData) -> Result<()> {
    data.texture_image_view = image_view::create_image_view(
        device,
        data.texture_image,
        vk::Format::R8G8B8A8_SRGB,
...
// mipmaps, probably need to not do this at runtime lol
