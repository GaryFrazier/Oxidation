...
pub unsafe fn create_depth_objects(
    ...
    let (depth_image, depth_image_memory) = image_view::create_image(
        instance,
        device,
        data,
    ...
    data.depth_image_view = image_view::create_image_view(device, data.depth_image, format, vk::ImageAspectFlags::DEPTH, 1)?;
